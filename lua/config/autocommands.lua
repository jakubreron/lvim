...
lvim.autocommands.custom_groups = {
  ...
  {
    "VimLeave",
    "~/.config/lvim/lua/config/autocommands.lua",
    "!cd ~/.config/lvim/; git add .; git commit -m 'feat(lvim): autocommands'; git push;",
  },
  {
    "VimLeave",
    "~/.config/lvim/lua/config/builtin.lua",
    "!cd ~/.config/lvim/; git add .; git commit -m 'feat(lvim): builtin'; git push;",
  },
  {
    "VimLeave",
    "~/.config/lvim/lua/config/general.lua",
    "!cd ~/.config/lvim/; git add .; git commit -m 'feat(lvim): general'; git push;",
  },
  {
    "VimLeave",
    "~/.config/lvim/lua/config/keymaps.lua",
    "!cd ~/.config/lvim/; git add .; git commit -m 'feat(lvim): keymaps'; git push;",
  },
  {
    "VimLeave",
    "~/.config/lvim/lua/config/lsp.lua",
    "!cd ~/.config/lvim/; git add .; git commit -m 'feat(lvim): lsp'; git push;",
  },
  {
    "VimLeave",
    "~/.config/lvim/lua/config/plugins.lua",
    "!cd ~/.config/lvim/; git add .; git commit -m 'feat(lvim): plugins'; git push;",
  },
}
