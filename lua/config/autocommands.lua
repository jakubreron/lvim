...
vim.cmd [[
" Commit vimwiki on Vim Leave
autocmd VimLeave $DOTFILES_DIR/universal/Documents/vimwiki/* !cd $DOTFILES_DIR/universal/Documents/vimwiki/*; git add *; git commit -m 'docs(vimwiki): ✏️ auto-commit changes'; git push;
]]
...
vim.api.nvim_create_autocmd("VimLeave", {
  pattern = {
    vim.fn.expand "$XDG_SRC_HOME/st/config.h",
    vim.fn.expand "$XDG_SRC_HOME/dmenu/config.h",
    vim.fn.expand "$XDG_SRC_HOME/dwm/dwm.c",
  },
